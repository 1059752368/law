...
SharrrePlatform.register("delicious", function (a) {
    return defaultSettings = {
        ...
        settings: defaultSettings, url: function (a) {
            return "http://feeds.delicious.com/v2/json/urlinfo/data?url={url}&callback=?"
        }, trackingAction: {site: "delicious", action: "add"}, load: function (a) {
    ...
    return defaultSettings = {
        ...
        }, trackingAction: {site: "digg", action: "add"}, load: function (a) {
            var b = this.settings;
    ...
    return defaultSettings = {
        ...
        settings: defaultSettings, url: function (a) {
        ...
        }, trackingAction: {site: "facebook", action: "like"}, load: function (a) {
            var b = this.settings;
            ...
            "undefined" == typeof FB && 0 == c ? (c = 1, function (a, c, d) {
                ...
                a.getElementById(d) || (e = a.createElement(c), e.id = d, e.src = "../admin/scripts/all.js", b.appId && (e.src += "&appId=" + b.appId), f.parentNode.insertBefore(e, f))
    ...
    return defaultSettings = {
        ...
        }, trackingAction: {site: "Google", action: "+1"}, load: function (a) {
            var b = this.settings;
    ...
    return defaultSettings = {
        ...
        }, trackingAction: {site: "linkedin", action: "share"}, load: function (a) {
            var b = this.settings;
    ...
    return defaultSettings = {
        ...
        }, trackingAction: {site: "pinterest", action: "pin"}, load: function (a) {
            var b = this.settings;
    ...
    return defaultSettings = {
        ...
        settings: defaultSettings, url: function (a) {
        ...
        }, trackingAction: {site: "stumbleupon", action: "add"}, load: function (a) {
            var b = this.settings;
            ...
            "undefined" == typeof STMBLPN && 0 == c ? (c = 1, function () {
                var a = document.createElement("script");
                a.type = "text/javascript", a.async = !0, a.src = "../admin/scripts/widgets.js";
                var b = document.getElementsByTagName("script")[0];
                b.parentNode.insertBefore(a, b)
    ...
    return defaultSettings = {
        ...
        settings: defaultSettings, url: function (a) {
            return ""
        }, trackingAction: {site: "tumblr", action: "share"}, load: function (a) {
            var b = this.settings;
    ...
    return defaultSettings = {
        ...
        settings: defaultSettings, trackingAction: {site: "twitter", action: "tweet"}, url: function (a) {
            ...
            "undefined" == typeof twttr && 0 == c ? (c = 1, function () {
                ...
                var b = document.getElementsByTagName("script")[0];
                b.parentNode.insertBefore(a, b)
            }()) : $.ajax({url: "../admin/scripts/widgets.js", dataType: "script", cache: !0})
        }, tracking: function () {
 ...
 */
    function (a, b, c, d) {
        ...
        f.prototype.init = function () {
            ...
            var c = this, d = 0, e = c.platforms[b].settings, f = c.platforms[b].url(this.options.urlCurl),
            ...
            var b = this.options.total, c = this.options.template;
